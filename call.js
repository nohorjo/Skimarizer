...
function findMax(sEntropy){
	...
	var sortedArray = maxArray.sort(function(a,b){return b-a});
...
{
	tuple.pureEntropy.sort(function(a,b){return b-a});
...
function topIMPwords(tuple,topentropy)
{
	...
	j = 0;
		...
		var sortedWordArray = wordArray.sort(function(a,b){return b-a});
...
for (i = 1; i <= total; i++){
	...
	setTimeout(function(){getTextOffDiv()}, 10000);
}
...
chrome.tabs.query({currentWindow:true,active:true}, (function(tab){
  chrome.tabs.sendMessage(tab[0].id, {message: "getSelection"}, function(response) {
